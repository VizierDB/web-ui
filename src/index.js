...
//bokeh_css.href = 'https://cdn.pydata.org/bokeh/release/bokeh-2.0.1.min.css'
...
//bokeh_widget_css.href = 'https://cdn.pydata.org/bokeh/release/bokeh-widgets-2.0.1.min.css'
//bokeh_widget_css.type = 'text/css'
//document.head.appendChild(bokeh_widget_css)

const bokeh_js = document.createElement('script')
bokeh_js.src = 'https://cdn.pydata.org/bokeh/release/bokeh-2.0.1.min.js'
bokeh_js.onload = function(){
	const bokeh_api_js = document.createElement('script')
	bokeh_api_js.src = 'https://cdn.pydata.org/bokeh/release/bokeh-api-2.0.1.min.js'
	document.head.appendChild(bokeh_api_js)
	const bokeh_widget_js = document.createElement('script')
	bokeh_widget_js.src = 'https://cdn.pydata.org/bokeh/release/bokeh-widgets-2.0.1.min.js'
